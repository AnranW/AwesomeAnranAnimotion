...
\titlegraphic{\includegraphics[width=0.15\textwidth]{presentation/images/onion.png}}
...
\begin{frame}[fragile]
	...
	\begin{figure}
        \centering
        \includegraphics[width=0.3\textwidth]{presentation/images/dst.png} 
    \end{figure}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{minipage}{.5\textwidth}
      \centering
      \includegraphics[width=0.7\linewidth]{presentation/images/dst.png}
    \end{minipage}%
    \begin{minipage}{.5\textwidth}
      \begin{itemize}
